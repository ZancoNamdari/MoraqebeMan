...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('audit', '0012_alter_auditlog_event_type'),
    ]
    ...
    operations = [
        migrations.AlterField(
            ...
            field=models.CharField(choices=[
                ...
                ('caregiver_interview_recorded', 'ثبت نتیجه مصاحبه مراقب'),
                ('caregiver_needs_more_documents', 'درخواست مدارک تکمیلی از مراقب'),
                ('candidate_field_edited', 'ویرایش اطلاعات مراقب توسط آژانس'),
