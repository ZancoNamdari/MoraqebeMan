    ...
    <div className="min-h-screen bg-gradient-to-b from-pink-50/50 via-background to-background pb-10">
      <header className="sticky top-0 z-10 border-b bg-background/90 backdrop-blur">
        <div className="mx-auto flex max-w-2xl items-center justify-between p-4">
          <h1 className="font-bold text-rose-900">پیشنهاد مراقب</h1>
          ...
          <>
            <Card className="border-pink-100 bg-gradient-to-l from-pink-50 to-rose-50">
              <CardContent className="p-4">
                ...
                <p className="text-lg font-bold text-rose-900">{data.patient_name}</p>
            ...
            {data.suggestions.length === 0 ? (
              ...
              <div className="space-y-3">
                {data.suggestions.map((s) => (
                  <Card key={s.caregiver_user_id} className="border-pink-100">
                    ...
                    <CardContent className="space-y-2">
                      <p className="text-sm font-medium text-rose-800">{s.explanation.summary}</p>
