    ...
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-gradient-to-br from-brand-pink via-brand-pink to-brand-mint-strong p-4">
      ...
      <Card className="relative w-full max-w-sm border-0 shadow-2xl">
        <CardHeader className="items-center text-center">
          ...
          <CardTitle className="text-xl">ورود ادمین</CardTitle>
          <CardDescription>بررسی و تأیید پروفایل مراقبان — مراقب من</CardDescription>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {error && (
              <div className="rounded-md border border-rose-200 bg-rose-50 p-2.5 text-sm text-rose-700">{error}</div>
            )}
            <Button
              type="submit"
